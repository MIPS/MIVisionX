...
#if ENABLE_MSA
	v16i8 *tbl = (v16i8 *) dataColorConvert;
	v16i8 maskLuma = __builtin_msa_ld_b(tbl + 3, 0);
	v16i8 maskChroma = __builtin_msa_ld_b(tbl, 0);
	v16i8 pixels0, pixels1, pixels0_NextRow, pixels1_NextRow, temp0, temp1;
	...
	)
{
...
#if ENABLE_MSA
	v16i8 *tbl = (v16i8 *) dataColorConvert;
	v16i8 maskY = __builtin_msa_ld_b(tbl + 3, 0);
	v16i8 maskU = __builtin_msa_ld_b(tbl + 4, 0);
	v16i8 maskV = __builtin_msa_ld_b(tbl + 5, 0);
	v16i8 pixels0, pixels1, pixels0_NextRow, pixels1_NextRow, temp0, temp1;
	...
	while (height)
	{
		...
		while (width)
		{
			...
			// Y plane, bytes 0..7
			temp0 = __builtin_msa_vshf_b(maskY, (v16i8) pixels0, (v16i8) pixels0);
			// Y plane, bytes 8..15
			temp1 = __builtin_msa_vshf_b(maskY, (v16i8) pixels1, (v16i8) pixels1);
			temp1 = __builtin_msa_sldi_b((v16i8) temp1, (v16i8) temp1, 8);
			temp0 = (v16i8) __builtin_msa_or_v((v16u8) temp0, (v16u8) temp1);
			__builtin_msa_st_b(temp0, pLocalDstY, 0);

			// Y plane - next row, bytes 8..15
			temp1 = __builtin_msa_vshf_b(maskY, (v16i8) pixels1_NextRow, (v16i8) pixels1_NextRow);
			temp1 = __builtin_msa_sldi_b((v16i8) temp1, (v16i8) temp1, 8);
			// Y plane - next row, bytes 0..7
			temp0 = __builtin_msa_vshf_b(maskY, (v16i8) pixels0_NextRow, (v16i8) pixels0_NextRow);
			temp0 = (v16i8) __builtin_msa_or_v((v16u8) temp0, (v16u8) temp1);
			__builtin_msa_st_b(temp0, pLocalDstYNextRow, 0);

			// U plane, intermideate bytes 4..7
			temp1 = __builtin_msa_vshf_b(maskU, (v16i8) pixels1, (v16i8) pixels1);
			// V plane, intermideate bytes 4..7
			pixels1 = __builtin_msa_vshf_b(maskV, (v16i8) pixels1, (v16i8) pixels1);
			temp1 = __builtin_msa_sldi_b((v16i8) temp1, (v16i8) temp1, 12);
			pixels1 = __builtin_msa_sldi_b((v16i8) pixels1, (v16i8) pixels1, 12);

			// U plane, intermideate bytes 0..3
			temp0 = __builtin_msa_vshf_b(maskU, (v16i8) pixels0, (v16i8) pixels0);
			// V plane, intermideate bytes 0..3
			pixels0 = __builtin_msa_vshf_b(maskV, (v16i8) pixels0, (v16i8) pixels0);
			// U plane, intermideate bytes 0..7
			temp0 = (v16i8) __builtin_msa_or_v((v16u8) temp0, (v16u8) temp1);
			// V plane, intermideate bytes 0..7
			pixels0 = (v16i8) __builtin_msa_or_v((v16u8) pixels0, (v16u8) pixels1);
			...
			// U plane - next row, intermideate bytes 4..7
			temp1 = __builtin_msa_vshf_b(maskU, (v16i8) pixels1_NextRow, (v16i8) pixels1_NextRow);
			// V plane - next row, intermideate bytes 4..7
			pixels1_NextRow = __builtin_msa_vshf_b(maskV, (v16i8) pixels1_NextRow, (v16i8) pixels1_NextRow);
			temp1 = __builtin_msa_sldi_b((v16i8) temp1, (v16i8) temp1, 12);
			pixels1_NextRow = __builtin_msa_sldi_b((v16i8) pixels1_NextRow, (v16i8) pixels1_NextRow, 12);

			// U plane - next row, intermideate bytes 0..3
			pixels1 = __builtin_msa_vshf_b(maskU, (v16i8) pixels0_NextRow, (v16i8) pixels0_NextRow);
			// V plane - next row, intermideate bytes 0..3
			pixels0_NextRow = __builtin_msa_vshf_b(maskV, (v16i8) pixels0_NextRow, (v16i8) pixels0_NextRow);
			// U plane - next row, intermideate bytes 0..7
			temp1 = (v16i8) __builtin_msa_or_v((v16u8) temp1, (v16u8) pixels1);
			// V plane - next row, intermideate bytes 0..7
			pixels0_NextRow = (v16i8) __builtin_msa_or_v((v16u8) pixels0_NextRow, (v16u8) pixels1_NextRow);
